            ...
            <div className="mt-3">
              <div className="py-3">
                ...
                <p className="text-xs lg:text-sm mt-3 font-normal">
                  ...
                  saepe accusantium delectus recusandae fugiat ea deleniti?
                  Consequatur saepe placeat repellat impedit ipsam dolores tempora
                  quasi nobis temporibus quae, natus perferendis.
                </p>
              </div>
            </div>
          </div>
