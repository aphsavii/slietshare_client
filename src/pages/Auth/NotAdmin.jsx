...
function NotAdmin() {
    ...
    return (
        <div className="text-center py-24 h-screen ">
            <h1 className="mb-4 text-6xl font-semibold text-primary">403</h1>
            ...
            <p className="mt-4 text-gray-600">Let's get you back <Link to="" className="text-blue-500">login</Link>.</p>
        </div>
        )
}
