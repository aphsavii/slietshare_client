...
import { ListCollapse,FileUp, Telescope } from 'lucide-react';
    ...
    <Popover className="">
      ...
      <PopoverContent className="bg-white w-40 md:w-[200px] py-5 px-2 md:px-4">
        <ul className='text-sm md:text-base text-gray-700'>
            ...
            <Telescope className='inline text-gray-500 mr-1 h-5 w-5'/> <span>Explore</span>
            </li>
            <Link to={'/qs/upload'}>
            <li className='py-2 border-b hover:text-primaryBlue cursor-pointer'>
            <FileUp className='inline text-gray-500 mr-1 h-5 w-5'/> <span>Upload Question</span>
            </li>
            </Link>
        </ul>
      </PopoverContent>
